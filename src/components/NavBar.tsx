...
export function NavBar() {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm px-4 sm:px-6 py-2 fixed top-0 left-0 right-0 z-[9999]">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        {/* Logo - Responsivo */}
        <div className="flex-shrink-0">
          <a href="/" className="flex items-center gap-2 sm:gap-2.5 hover:opacity-80 transition-opacity">
            <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-lg flex items-center justify-center shadow-md">
        ...
        <button
          ...
          className="xl:hidden justify-self-end p-2 text-gray-600 hover:text-emerald-600"
      ...
      {isMobileMenuOpen && (
        <div className="xl:hidden bg-white/98 border-t border-gray-200 px-6 py-5 shadow-lg relative z-[9999]">
